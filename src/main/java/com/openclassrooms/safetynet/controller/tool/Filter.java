...
public class Filter
{
    public static FilterProvider keepAllFieldsFilterProvider= getPersonFilterProvider("firstName","lastName","address","zip", "city","phone","email","age","allergies","medications" );
